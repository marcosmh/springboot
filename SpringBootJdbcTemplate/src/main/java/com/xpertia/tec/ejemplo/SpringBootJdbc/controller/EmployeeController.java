package com.xpertia.tec.ejemplo.SpringBootJdbc.controller;
...
import com.xpertia.tec.ejemplo.SpringBootJdbc.service.IEmployeeService;
...
public class EmployeeController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Integer> guardarEmpleado(@RequestBody Employee employee) {
		LOGGER.info("Peticion recibida para guardar Empleado");
		return new ResponseEntity<Integer>(service.save(employee),HttpStatus.OK);
	}
	 ...
	 */
	@PutMapping
	public ResponseEntity<Integer> actualizarEmpleado(@RequestBody Employee employee) {
		LOGGER.info("Peticion recibida para actualizar empleado");
		return new ResponseEntity<Integer>(service.update(employee),HttpStatus.OK);
	}
